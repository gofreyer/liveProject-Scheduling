...
namespace critical_paths
{
    public static class Extensions
    {
        ...
        // Return a random nuber betweeen min and max.
        public static double Next(this Random rand, double min, double max)
        {
            double width = max - min;
            return min + rand.NextDouble() * width;
        }
    }
}
